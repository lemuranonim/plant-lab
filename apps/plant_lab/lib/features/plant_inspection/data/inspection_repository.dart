...
final formTemplatesProvider = FutureProvider<List<Map<String, dynamic>>>((
  ref,
) async {
  return ref.watch(inspectionRepositoryProvider).fetchFormTemplates();
});

final recentInspectionsProvider = FutureProvider<List<Map<String, dynamic>>>((
  ref,
) async {
...
class InspectionRepository {
  ...
  Future<Map<String, dynamic>?> fetchFormTemplateByProcess(
    String processType,
  ) async {
    final response = await supabase
        .from('pl_form_templates')
